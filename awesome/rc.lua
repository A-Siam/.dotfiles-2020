...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "apostrophe", awful.client.urgent.jumpto,
    ...
    awful.key({ modkey, "Shift"   }, "grave", awesome.quit,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "[",  awful.client.floating.toggle                     ,
     ...
     awful.key({ modkey,  }, "u", function (c) c:swap(awful.client.getmaster()) end,
