...
set -x SCRIPTS_PATH $HOME/.scripts
...
alias ezb="source $SCRIPTS_PATH/ezb_ pmenu"
...
# general path
set -x PATH $PATH:$ORACLE_HOME/bin:$HOME/bin:$HOME/.cargo/bin:$HOME/.node_modules/bin:$HOME/.local/bin
